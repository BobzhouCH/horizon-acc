(function () {
    ...
    .service('lenovoNetworkSwitchesAction',
    ['$modal', 'horizon.dashboard.lenovo.network_switches.Path',
        'horizon.openstack-service-api.switch', 'horizon.framework.widgets.toast.service',
          function (modal, path, switchAPI, toastService) {
              ...
              function action(scope) {
                  ...
                  self.openDetail = function (switchData) {
                      openDetailOption.resolve.switchData = function () { return switchData };
                  ...
                  self.editSwitch = function (selectedSwitch) {
                      if (selectedSwitch || selectedSwitch.length > 0) {
                          editSwitchOption.resolve.switchData = function () { return selectedSwitch[0] };
                  ...
                  self.deleteSwitch = function (switches) {
                      if (switches) {
                          ...
                          deleteSwitchOption.resolve.switchIds = function () { return switchIds };
                          deleteSwitchOption.resolve.switchNames = function () { return switchNames.join(',') };
                  ...
                  self.createDetailSwitch = function (switchData) {
                      createDetailSwitchOption.resolve.switchData = function () { return switchData };
                  ...
                  self.editDetailSwitch = function (data) {
                      editDetailSwitchOption.resolve.switchData = function () { return data[0] };
                  ...
                  self.deleteDetailSwitch = function (data) {
                      if (data[1] || data[1].length > 0) {
                          ...
                          deleteDetailSwitchOption.resolve.switchData = function () { return data[0] };
                          deleteDetailSwitchOption.resolve.nodeNames = function () { return ids.join(',') };
                          deleteDetailSwitchOption.resolve.nodeIds = function () { return ids };
