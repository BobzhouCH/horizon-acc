...
class Step(object):
    ...
    * The connections between this step's fields and changes in the context
    ...
    after = None
    help_text = ""
    template_name = "easystack_dashboard/common/_workflow_step.html"
...
class UpdateMembersStep(Step):
    ...
    """
    template_name = "easystack_dashboard/common/_workflow_step_update_members.html"
    show_roles = True
...
class Workflow(html.HTMLElement):
    ...
    * Verifying/validating the overall data integrity and subsequently
    ...
    slug = None
    default_steps = ()
    template_name = "easystack_dashboard/common/_workflow.html"
