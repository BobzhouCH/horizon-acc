...
class Row(html.HTMLElement):
    ...
    def render(self):
        return render_to_string("easystack_dashboard/common/_es_data_table_row.html",
                                {"row": self})
...
class Cell(html.HTMLElement):
    ...
    def render(self):
        return render_to_string("easystack_dashboard/common/_es_data_table_cell.html",
                                {"cell": self})
...
class DataTableOptions(object):
    ...
    def __init__(self, options):
        ...
        self.template = getattr(options,
                                'template',
                                'easystack_dashboard/common/_es_data_table.html')
        self.row_actions_dropdown_template = getattr(
            options,
            'row_actions_dropdown_template',
            'easystack_dashboard/common/_es_data_table_'
            'row_actions_dropdown.html')
        self.row_actions_row_template = getattr(
            options,
            'row_actions_row_template',
            'easystack_dashboard/common/_es_data_table_'
            'row_actions_row.html')
        self.table_actions_template = getattr(
            options,
            'table_actions_template',
            'easystack_dashboard/common/_es_data_table_table_actions.html')
...
class DataTable(object):
    ...
    def row_render(self, row):
        """Provides a way to override default rendering of row update."""
    ...
    def maybe_preempt(self):
        ...
        if table_name == self.name:
            ...
            if new_row.ajax and new_row.ajax_action_name == action_name:
                ...
                if request.is_ajax():
                    if not error:
                        return self.row_render(new_row)
                    else:
    ...
    def get_page_size(self):
        """Returns the items per page from settings."""
        return utils.get_page_size(self.request)
