...
from easystack_dashboard.api.rest import notify

urlpatterns = []

urlpatterns.append(url(r'^ceilometer/sendmail', notify.sendemail, name='mail'))
...
def register(view):
    ...
    p.add_prefix('easystack_dashboard.rest_api')
