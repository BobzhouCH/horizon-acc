...
(function () {
  ...
  angular
    ...
    .controller('LaunchBareInstanceNetworkHelpController', LaunchInstanceNetworkHelpController);
  ...
  function LaunchInstanceNetworkHelpController() {
    ...
    ctrl.paragraphs = [
      ...
      gettext('An <b>External</b> network is set up by an administrator. If you want an instance to communicate outside of the data center, then attach a router between your <b>Project</b> network and the <b>External</b> network.'),
