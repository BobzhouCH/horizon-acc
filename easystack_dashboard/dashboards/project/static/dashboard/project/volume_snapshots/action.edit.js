...
(function() {
   ...
   */
  .factory('editVolumeSnapshotAction',
       ['horizon.openstack-service-api.cinder',
        '$modal',
        'backDrop',
        'horizon.dashboard.volume_snapshot.PATH',
        'horizon.framework.widgets.toast.service',
  function(cinderAPI, modal, backDrop, path, toastService) {

    var context = {
      mode: 'edit',
      title: gettext('Edit Volume Snapshot'),
      submit: gettext('Save'),
      success: gettext('Volume snapshot %s has been updated successfully.')
    };
    ...
    function action(scope) {
      ...
      self.submit = function(volume, clone) {
        ...
        cinderAPI.editVolumeSnapshot(cleanedVolumesnapshot)
          .success(function() {
