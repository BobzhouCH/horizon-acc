...
(function() {
 ...
 angular.module('hz.dashboard.identity.domains')
  .directive('domainQuotaItem',function(){
     return {
          require: '^form',
          restrict: 'AE',
          templateUrl: 'domain_quota/domain_quota_item.html',
          scope:{
            id: '@',
            name: '@',
            label: '@',
          ...
          link: function(scope, element, attrs, form){
                ...
                scope.toggleCheckState = function(){
                    ...
                    if (quota.unlimit && !quota.checked) {
                        quota.checked = true;
                    ...
                    if (quota.checked){
                      ...
                      var value = quota.init == -1 ? quota.used : quota.init;
...
.directive('domainQuotaValidate', function(){
