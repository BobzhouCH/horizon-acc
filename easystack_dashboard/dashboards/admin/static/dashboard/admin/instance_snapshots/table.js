...
/**
* @ngdoc snapshotsInstanceAdminCtrl
* @ngController
*
* @description
...
*/
.controller('snapshotsInstanceAdminCtrl', [
'$scope', '$rootScope', 'horizon.openstack-service-api.glance',
'editInstanceSnapshotAdminAction',
'deleteInstanceSnapshotAdminAction',
'createInstanceSnapshotVolumeAdminAction',
function(
    ...
    this.refresh = function(){
        ...
        .success(function(response) {
            ...
            if (response.items){
                ...
                //begin:jiaozh1:add:2016-12-02:bug:Bugzilla - bug 75376
